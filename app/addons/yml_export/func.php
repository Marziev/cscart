...
function fn_yml_get_console_cmd($price_list)
{
    ...
    if (isset($price_list['param_data']['storefront_id'])) {
        $console_cmd .= ' --switch_storefront_id=' . $price_list['param_data']['storefront_id'];
    } else {
...
function fn_yml_get_key($price_list)
{
    ...
    if (!isset($key[$price_list['param_id']])) {
        ...
        if (isset($price_list['param_data']['enable_authorization']) && $price_list['param_data']['enable_authorization'] === 'N') {
