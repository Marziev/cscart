                            ...
                            <div class="ty-grid-list__item ty-quick-view-button__wrapper ">
                                ...
                                <div class="ty-grid-list__item-name">
                                    <bdi>
                                        ...
                                        <a href="{"departments.department?department_id={$department.department_id}"|fn_url}" class="product-title" title="{$department.department}">{$department.user_id|fn_get_user_name}</a>    
                                    </bdi>
                                </div>
                            </div>
                        {/if}
